...
{
	private static readonly HashSet<VirtualXboxControl> AxisTargets =
	[
	...
	public static bool IsAxisTarget(VirtualXboxControl control)
	...
	public static ControllerProfile RemoveBinding(ControllerProfile profile, VirtualXboxControl target)
		=> profile with
		{
			Bindings = profile.Bindings
