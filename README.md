...
- `AmigaTracker.Abstractions` - shared playback interfaces.
- `AmigaTracker.Med` - MED / OctaMED backend.
- `AmigaTracker.ProTracker` - ProTracker MOD backend.
- `AmigaTracker.Sid` - PSID / RSID backend.
