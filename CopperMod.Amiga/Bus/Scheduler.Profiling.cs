    ...
    internal sealed partial class Scheduler
    {
        ...
        public AmigaHardwareSchedulerSnapshot CaptureSnapshot()
        {
            ...
            return new AmigaHardwareSchedulerSnapshot(
                ...
                _bus.DeferredCpuTimingProjectionAttempts,
                _bus.DeferredCpuTimingProjectionSupported,
                _bus.DeferredCpuTimingProjectionMatches,
                _bus.DeferredCpuTimingProjectionMismatches,
                _bus.DeferredCpuTimingProjectionFirstMismatch,
                _bus.DeferredCpuChipInstructionFetchShadowAttempts,
                _bus.DeferredCpuChipInstructionFetchShadowSupported,
                _bus.DeferredCpuChipInstructionFetchShadowMismatches,
                _bus.DeferredCpuChipInstructionFetchShadowFirstMismatch,
                ...
                _hostAgnusTicks,
                _hostBlitterTicks,
                _hostCausalExecutorTicks,
                _bus.CausalBusExecutor.AgendaReads,
                _bus.CausalBusExecutor.AgendaUpdates,
                _bus.CausalBusExecutor.CpuTimingSequenceAttempts,
                _bus.CausalBusExecutor.CpuTimingSequenceRuns,
                _bus.CausalBusExecutor.CpuTimingSequenceWords,
                _bus.CausalBusExecutor.CpuTimingSequenceBarrierRejects,
                _bus.CausalBusExecutor.CpuTimingSequenceSlotRejects,
                _bus.CausalBusExecutor.CpuInstructionFetchGrantedWords,
                _bus.CausalBusExecutor.CpuChipRamInstructionFetchGrantedWords,
                _bus.CausalBusExecutor.CpuDataGrantedWords,
                _bus.CausalBusExecutor.CpuVisibilityQueries,
                _bus.CausalBusExecutor.CpuVisibilityStoppedQueries,
                ...
                _bus.CausalBusExecutor.CpuVisibilityExpiredRoot,
                _bus.CausalBusExecutor.CpuVisibilityExpiredCopperState,
                _bus.CausalBusExecutor.CpuChipFetchLeaseAttempts,
                _bus.CausalBusExecutor.CpuChipFetchLeaseAccepted,
                _bus.CausalBusExecutor.CpuChipFetchLeaseRejected,
                _bus.CausalBusExecutor.CpuChipFetchLeaseRejectedInvalid,
                _bus.CausalBusExecutor.CpuChipFetchLeaseRejectedNoStableInterval,
                _bus.CausalBusExecutor.CpuChipFetchCopperLookaheadAttempts,
                _bus.CausalBusExecutor.CpuChipFetchCopperLookaheadAccepted,
                _bus.CausalBusExecutor.CpuChipFetchCopperLookaheadContinuationAttempts,
                _bus.CausalBusExecutor.CpuChipFetchCopperLookaheadContinuations,
                _bus.CausalBusExecutor.CpuChipFetchWordsProven,
                _bus.CausalBusExecutor.CpuChipFetchProofRejectedLease,
                _bus.CausalBusExecutor.CpuChipFetchProofRejectedLeaseExpired,
                _bus.CausalBusExecutor.CpuChipFetchProofRejectedFixedPlan,
                _bus.CausalBusExecutor.CpuChipFetchProofRejectedMapping,
                _bus.CausalBusExecutor.CpuChipFetchProofRejectedLeaseWriter,
                _bus.CausalBusExecutor.CpuChipFetchProofRejectedInput,
                _bus.CausalBusExecutor.CpuChipFetchProofRejectedWriter,
                _bus.CausalBusExecutor.CpuChipFetchProofRejectedDynamic,
                _bus.CausalBusExecutor.CpuChipFetchProofRejectedUnsupportedOwner,
                _bus.CausalBusExecutor.CpuChipFetchCommitAttempts,
                _bus.CausalBusExecutor.CpuChipFetchCompletedRuns,
                _bus.CausalBusExecutor.CpuChipFetchPartialRuns,
                _bus.CausalBusExecutor.CpuChipFetchCommittedWords,
                _bus.CausalBusExecutor.CpuChipFetchGrantMismatches,
                _bus.CausalBusExecutor.CpuChipFetchValueMismatches,
                _bus.CausalBusExecutor.CpuChipFetchFixedSlotsRefresh,
                _bus.CausalBusExecutor.CpuChipFetchFixedSlotsBitplane,
                _bus.CausalBusExecutor.CpuChipFetchFixedSlotsSprite,
                _bus.CausalBusExecutor.CpuChipFetchFixedSlotsScanned,
                _bus.CausalBusExecutor.CpuChipFetchMaxFixedSlotsScannedPerWord,
                _bus.CausalBusExecutor.CpuChipFetchTotalWaitCycles,
                _bus.CausalBusExecutor.CpuChipFetchRunLength1,
                _bus.CausalBusExecutor.CpuChipFetchRunLength2,
                _bus.CausalBusExecutor.CpuChipFetchRunLength3To4,
                _bus.CausalBusExecutor.CpuChipFetchRunLength5To8,
                _bus.CausalBusExecutor.CpuChipFetchRunLength9To16,
                _bus.CausalBusExecutor.CpuChipFetchRunLength17To32,
                _bus.CausalBusExecutor.CpuChipFetchRunLength33To64,
                _bus.DeferredCpuChipFetchAdmissionAttempts,
                _bus.DeferredCpuChipFetchAdmissionInactive,
                _bus.DeferredCpuChipFetchAdmissionEnvironment,
                _bus.DeferredCpuChipFetchAdmissionMapping,
                _bus.DeferredCpuChipFetchAdmissionMixedJournal,
                _bus.DeferredCpuChipFetchAdmissionCapacity,
                _bus.DeferredCpuChipFetchAdmissionLeaseRejected,
                _bus.DeferredCpuChipFetchAdmissionProofRejected,
                _bus.DeferredCpuChipFetchAdmissionAccepted,
                _bus.DeferredCpuChipFetchFixedPlanFirstRejects,
                _bus.DeferredCpuChipFetchFixedPlanRejectBatchActive,
                _bus.DeferredCpuChipFetchFixedPlanRejectExecutionStarted,
                _bus.DeferredCpuChipFetchFixedPlanRejectJournalEmpty,
                _bus.DeferredCpuChipFetchFixedPlanRejectJournalNonEmpty,
                _bus.DeferredCpuChipFetchFixedPlanRejectRebased,
                _bus.DeferredCpuChipFetchFixedPlanFirstTrace);
        }
